                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>"  method="post" enctype="multipart/form-data" id="course-form">
                            <div class="grid grid-cols-2 gap-2 mt-4">
                                <div>
                                    ...
                                    <input type="text" value="<?php echo isset($course_code) ? $course_code : '' ?>"  name="course_code" id="course_code" class="bg-transparent border-2 border-gray-700 rounded-md px-2 py-2 w-full outline-none focus:border-blue-500 duration-300 text-gray-400" >
                                </div>  
                                <div class="relative">
                                    <label for="course_name" class="text-blue-500">Course name *</label><br>
                                    <input type="text"  value="<?php echo isset($course_name) ? $course_name : '' ?>"  name="course_name" id="course_name" class="bg-transparent border-2 border-gray-700 rounded-md px-2 py-2 w-full outline-none focus:border-blue-500 duration-300 text-gray-400 peer" >
                                ...
                                <div>
                                    ...
                                    <input type="number" min="1" value="<?php echo isset($credit) ? $credit : '' ?>"  name="credit" id="credit"  class="bg-transparent border-2 border-gray-700 rounded-md px-2 py-2 w-full outline-none focus:border-blue-500 duration-300 text-gray-400" >
                                </div>
                                <div >
                                ...
                                <label for="description" class="text-blue-500">Description *</label><br>
                                    <textarea rows="6" value="<?php echo isset($desc) ? $desc : '' ?>" name="description" id="description"   class="bg-transparent border-2 border-gray-700 rounded-md px-2 py-2 w-full outline-none focus:border-blue-500 duration-300 text-gray-400 " >
